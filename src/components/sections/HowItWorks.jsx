...
export default function HowItWorks() {
  return (
    <div id="how-it-works" className="bg-primary-100 py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl text-center">
          ...
          >
            ...
            <p className="mt-6 text-lg leading-8 text-primary-600">
              Get started with Wiraspot in three easy steps. No technical
              expertise required.
            </p>
          </motion.div>
        </div>
            ...
            {steps.map((step) => (
              ...
              >
                <motion.div
                  ...
                  className="mb-6 flex h-16 w-16 items-center justify-center rounded-full bg-primary"
                >
                  <step.icon
                ...
                <dt className="text-xl font-semibold leading-7 text-primary-900">
                  <div className="mb-2 text-primary">Step {step.id}</div>
                  {step.name}
                </dt>
        ...
        >
          ...
          <div className="relative flex justify-center">
            <span className="bg-primary-100 px-4">
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center gap-x-2 rounded-full bg-primary px-8 py-3 text-sm font-semibold text-white shadow-sm hover:bg-primary-600 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
              >
                Get Started Now
                <svg
                  className="h-5 w-5"
        ...
        <motion.div
          className="mt-16 rounded-2xl bg-white p-8 sm:mt-24 sm:p-16"
